<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('reports_management_access')
            <li
                class="c-sidebar-nav-dropdown {{ request()->is('admin/reports*') ? 'c-show' : '' }} {{ request()->is('admin/categories*') ? 'c-show' : '' }} {{ request()->is('admin/faqs*') ? 'c-show' : '' }} {{ request()->is('admin/sections*') ? 'c-show' : '' }} {{ request()->is('admin/chapters*') ? 'c-show' : '' }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.reportsManagement.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('report_access')
                        <li class="c-sidebar-nav-item">
                    ...
                    @can('chapter_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.chapters.index') }}"
                                class="c-sidebar-nav-link {{ request()->is('admin/chapters') || request()->is('admin/chapters/*') ? 'c-active' : '' }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
